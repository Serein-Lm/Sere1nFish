...
def _as_monitor(
    ...
    return {
        ...
        "incremental_by_time": bool(task.get("incremental_by_time")),
        "incremental_since": task.get("incremental_since"),
        "incremental_overlap_hours": int(task.get("incremental_overlap_hours", 24)),
