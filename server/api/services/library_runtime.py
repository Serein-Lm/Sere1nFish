...
CORE_PROMPT_SLUGS = {
    ...
    "persona_research_plan/persona_research_plan",
    ...
    "mobile_collect/social_media_frame",
    "mobile_collect/list_triage",
    "mobile_collect/detail_extract",
    "mobile_collect/screen_extract",
    "mobile_collect/screen_summary",
    "mobile_agent/planner",
    "mobile_agent/replanner",
    "mobile_agent/screen_describe",
    "mobile_agent/chat_screen",
    "mobile_agent/chat_state",
    "mobile_agent/chat_compose",
