...
def disable_thinking_extra_body(
    ...
    """Return an extra_body with thinking explicitly disabled."""
...
class ModelConfig:
    ...
    Attributes:
        ...
        max_tokens: 响应最大 token 数；None 表示不显式传给后端
    ...
    extra_body: dict[str, Any] = field(default_factory=disable_thinking_extra_body)
    lang: str = "cn"
