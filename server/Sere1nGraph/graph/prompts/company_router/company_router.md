...
7. `colloquial_names` 只放同一法律主体的可信简称、品牌名、英文名和真实口语名，优先给出 2-6 个。母公司、子公司、分公司、事业部、服务部、关联机构和相似名称不是别名，必须排除。
8. 不得为了凑数量臆造简称。无法从公开信息或名称结构确认的别名不要输出；法定全称去掉“有限公司”等法律后缀可以作为低风险简称。
...
- `company_profile.colloquial_names`：去重后的同主体品牌名、简称、中文/英文口语名；不得混入上下级或关联单位。
